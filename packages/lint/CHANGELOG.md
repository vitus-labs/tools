...
- [#158](https://github.com/vitus-labs/tools/pull/158) [`10f24a6`](https://github.com/vitus-labs/tools/commit/10f24a65a26c7f4f7e6ec9819ee2420914fdc51d) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Migrate biome config to 2.5 schema. Bumps `@biomejs/biome` devDep to `~2.5.1` and updates the shared `biome.shared.json`.
...
**Note:** Version bump only for package @vitus-labs/tools-lint
